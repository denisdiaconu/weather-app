...
function Inputs({setQuery}) {
  ...
  return (
    <div className=' flex flex-row items-center justify-center pt-7'>
        ...
        <UilSearch size={30} onClick={searchClick} className='text-white mr-2 cursor-pointer transition ease-in-out md:hover:scale-125 md:hover:rotate-12' />
        <UilLocationPinAlt size={30} onClick={locationClick} className='text-white cursor-pointer transition ease-in-out md:hover:scale-125' />
    </div>
  )
}
