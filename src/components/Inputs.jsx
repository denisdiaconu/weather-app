...
function Inputs({setQuery}) {
  ...
  return (
    <div className=' flex flex-row items-center justify-center pt-7'>
        <input type="text" value={city} onChange={(c) => setCity(c.currentTarget.value)} className='text-2xl md:w-90 w-8/12 capitalize focus:outline-none font-normal p-1.5 mr-3' placeholder='Search city...' />
