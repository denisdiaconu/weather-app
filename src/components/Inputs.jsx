...
function Inputs({setQuery}) {
  ...
  return (
    <div className='flex flex-row items-center justify-center my-6'>
        <input type="text" value={city} onChange={(c) => setCity(c.currentTarget.value)} className='text-2xl w-90 capitalize focus:outline-none font-normal p-1.5 mr-3' placeholder='Search city...' />
